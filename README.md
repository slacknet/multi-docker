# Steps to build a react application and in this case is a fibonacci calcualator using a multi container process to deploy in AWS: Redis, Postgres and the App
